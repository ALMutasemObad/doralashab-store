...
<footer class="site-footer">
	<div class="da-container footer-grid">
		...
		<div class="footer-links-cluster" aria-label="روابط الموقع والخدمات">
			<div class="footer-column footer-links-column"><h2>تصفح</h2><ul><li><a href="<?php echo esc_url( home_url( '/shop/' ) ); ?>">كل الكتب</a></li><li><a href="<?php echo esc_url( home_url( '/childrens-books/' ) ); ?>">كتب الأطفال</a></li><li><a href="<?php echo esc_url( home_url( '/school-books/' ) ); ?>">كتب المدارس</a></li><li><a href="<?php echo esc_url( home_url( '/about-us/' ) ); ?>">عن الدار</a></li></ul></div>

...
<section class="da-section da-section--white">
	<div class="da-container">
		<div class="da-section-heading" data-reveal><div><h2>ما تحتاجه المكتبة خلال دورة حياتها</h2><p class="da-kicker">منظومة الخدمة</p></div><p>يمكن تنفيذ خدمة محددة أو بناء مسار مترابط وفق نطاق المشروع واعتماد الجهة.</p></div>
...
<section class="da-section da-quality-section">
	<div class="da-container da-quality-grid">
		<div data-reveal><h2>وضوح يمكن مراجعته في كل مرحلة</h2><p class="da-kicker">ضبط الجودة والتوثيق</p><p>نربط جودة التنفيذ بأثر واضح داخل المشروع: مواصفات محددة، مراجعة للمطابقة، توثيق للملاحظات، وتسليم منظم.</p></div>
...
<section class="da-section da-library-deliverables">
	<div class="da-container da-deliverables da-deliverables--page" data-reveal>
		<div class="da-deliverables-copy"><h2>ما الذي يمكن أن تستلمه الجهة؟</h2><p class="da-kicker da-kicker--light">مخرجات المشروع</p><p>تتحدد المخرجات بحسب طبيعة المشروع ونطاقه، وقد تشمل:</p></div>

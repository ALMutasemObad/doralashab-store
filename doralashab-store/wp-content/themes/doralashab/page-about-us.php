...
<section class="da-section da-section--white">
	<div class="da-container da-story-grid">
		<div class="da-story-heading" data-reveal><h2>من دار للنشر والتوزيع<br>إلى منظومة تخدم المؤسسة</h2><p class="da-kicker">قصتنا</p></div>
...
<section class="da-section da-direction-section">
	<div class="da-container">
		<div class="da-direction-grid">
			<article class="da-direction-card da-direction-card--green" data-reveal><span><?php doralashab_icon( 'target' ); ?></span><h2>شريك موثوق في صناعة ونشر المعرفة</h2><p class="da-kicker da-kicker--light">رؤيتنا</p><p>أن تكون دور الأصحاب حضوراً مؤثراً لدى القارئ والمؤسسة، وأن تربط جودة المحتوى بجودة التنفيذ والوصول.</p></article>
			<article class="da-direction-card" data-reveal><span><?php doralashab_icon( 'document' ); ?></span><h2>محتوى رصين ومخرجات واضحة</h2><p class="da-kicker">رسالتنا</p><p>إنتاج محتوى رصين، ودعم المؤلف، وتقديم حلول نشر ومكتبات تنتهي بمخرجات قابلة للمراجعة والاستلام.</p></article>
		</div>
...
<section class="da-section da-saudi-vision-section">
	<div class="da-container da-saudi-vision-grid">
		<div data-reveal><h2>معرفة تنمو مع طموح المملكة</h2><p class="da-kicker">هوية سعودية</p><p>تنطلق دور الأصحاب من المملكة العربية السعودية، وتسهم عبر النشر والتوزيع وحلول المكتبات في تعزيز الوصول إلى المعرفة وخدمة القطاعات التعليمية والثقافية.</p></div>

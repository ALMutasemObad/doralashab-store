...
<section class="da-inner-hero da-inner-hero--paper" aria-labelledby="publishing-title">
	<div class="da-container da-inner-hero-layout">
		<div data-reveal><h1 id="publishing-title"><span>من المخطوط</span><span>إلى القارئ</span></h1><p class="da-kicker">النشر والإنتاج المعرفي</p><p>نرافق الكتاب عبر مراحل مترابطة تحمي جودة المحتوى والهوية والمنتج النهائي، وتمنح المؤلف والجهة مساراً واضحاً.</p><div class="da-hero-actions"><a class="da-button" href="<?php echo esc_url( home_url( '/contact/' ) ); ?>">ناقش مشروع كتابك <?php doralashab_icon( 'arrow' ); ?></a></div></div>
...
<section class="da-section da-section--white">
	<div class="da-container">
		<div class="da-section-heading" data-reveal><div><h2>خدمات مترابطة تحمي جودة الكتاب</h2><p class="da-kicker">دورة الإنتاج</p></div><p>كل مرحلة تبني على التي قبلها، من تقييم المادة إلى جاهزية الإصدار ووصوله.</p></div>
...
<section class="da-section da-publishing-path">
	<div class="da-container">
		<div class="da-section-heading" data-reveal><div><h2>قرار واضح عند كل انتقال</h2><p class="da-kicker">منهج التنفيذ</p></div><p>يساعد تسلسل المراحل على ضبط التوقعات والمراجعات والاعتمادات قبل الانتقال إلى الإنتاج.</p></div>
